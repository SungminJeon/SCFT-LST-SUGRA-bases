#!/bin/bash
# Run full SUGRA pipeline with explicit OpenMP thread count.
#
# Usage:   ./run_pipeline_omp.sh T_MIN T_MAX [N_THREADS]
# Example: ./run_pipeline_omp.sh 0 10 8     # T=0..10 with 8 threads
#          ./run_pipeline_omp.sh 21 30 32   # T=21..30 with 32 threads
#
